...
describe('UpdateProfile', () => {
  ...
  it('should not be able to update profile user from a non-existing user', async () => {
    await expect(
  ...
  it('should not be able to email to an email already in use by another user', async () => {
